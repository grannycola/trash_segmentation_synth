...
class TacoDatasetSegmentation(Dataset):
    ...
    def __init__(self, json_ann_file=None, input_size=(512, 512), classes=None,):
        ...
        self.masks_files_list = os.listdir('data/resized/masks_2_classes/')
    ...
    def __getitem__(self, index):
        ...
        mask_filename = self.masks_files_list[index]
        path_to_mask = 'data/resized/masks_2_classes/' + mask_filename
        
        
        img_path = 'data/resized/images/' + mask_filename
    ...
    def __len__(self):
        return len(self.masks_files_list)
...
class TacoLoaders:
    ...
    def __init__(self, preprocessing_fn, batch_size = 4, augmentation=None,
                 train_size_perc=0.9):

        self.train_dataset = TacoDatasetSegmentation()
    ...
    def show_example(self):
        ...
        visualize(image=image.transpose((1, 2, 0)),
                  mask=mask.transpose((1, 2, 0)) * 255 ### if you use DiceLoss
                  #mask=mask * 255 
                 )    